...
def test_d2_policy_identity_keeps_scheduler_and_evidence_versions_separate():
    ...
    assert sched.policy_version == "V31_SCHED_SHADOW_003"
    assert evidence.policy_version == "V31_SCHED_EVIDENCE_002"
...
def test_d2_evaluation_ledger_records_required_frozen_facts_and_never_authoritative(tmp_path):
    ...
    assert row["scheduler_policy_version"] == "V31_SCHED_SHADOW_003"
    assert row["evidence_policy_version"] == "V31_SCHED_EVIDENCE_002"
